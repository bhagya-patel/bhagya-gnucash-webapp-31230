...
export const ChatbotWidget = () => {
  ...
  return (
    <>
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-20 left-6 w-[380px] h-[600px] bg-card rounded-2xl shadow-2xl flex flex-col z-40 border border-border animate-scale-in">
          {/* Header */}
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-6 left-20 h-14 w-14 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-2xl z-40 animate-fade-in"
          size="icon"
        >
