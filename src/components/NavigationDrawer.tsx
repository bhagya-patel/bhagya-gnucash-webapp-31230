        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto bg-background">
            ...
            <div className="border-b border-border">
              <Button
                variant="ghost"
                className="w-full justify-start px-4 py-3 h-auto text-foreground hover:bg-accent transition-smooth rounded-none"
              >
            ...
            <div className="py-2">
              ...
              <Button
                variant="ghost"
                className="w-full justify-start px-4 py-3 h-auto text-foreground hover:bg-accent transition-smooth rounded-none group"
                onClick={() => {
